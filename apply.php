<?php
    ...
    if (isset($_POST['apply'])) {
        ...
        } elseif (empty($fieldOfWork)) {
            $error['d'] = "Select field of work";
        ...
        if (count($error) == 0) {
            $applyquery = "INSERT INTO doctorapplications(Username, Password, FirstName, LastName, Email, PhoneNumber, FieldOfWorkId )
                        VALUES('$username', '$password', '$firstName', '$lastName', '$email', '$phoneNumber', '$fieldOfWork')";
            $result = mysqli_query($connect, $applyquery);
...
<form method="post">
        ...
        <div class="form-group">
            ...
            <br>
            <select type="text" name="fieldOfWork" id="fieldOfWork">
                <?php
                    $query = "SELECT * FROM fieldofwork";
